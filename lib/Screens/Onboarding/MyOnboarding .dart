...
import 'package:emi_calculator/Screens/Onboarding/custom_bg.dart';
import 'package:emi_calculator/Screens/Onboarding/data.dart';
import 'package:emi_calculator/Screens/Onboarding/widgets.dart';
                        ...
                        child: Transform.rotate(
                          ...
                          child: ClipPath(
                            ...
                            child: AnimatedContainer(
                              duration: const Duration(milliseconds: 300),
                              color:
                                  myColors[selectedIndex + 1].withOpacity(0.8),
                            ),
                          ),
                        ))
                    : Positioned(
                        ...
                        child: Transform.rotate(
                          ...
                          child: ClipPath(
                            ...
                            child: AnimatedContainer(
                              duration: const Duration(milliseconds: 300),
                              color:
                                  myColors[selectedIndex + 1].withOpacity(0.9),
                            ),
                          ),
                        )),
                      ...
                      children: [
                        InkWell(
                          onTap: () async {
                            isAdmob
                                ? interstitialAd!.show()
                                : loadFacebookInterstitialSplsshAd();
