// ignore_for_file: prefer_interpolation_to_compose_strings, file_names, deprecated_member_use
import 'dart:io';
import 'dart:math';
...
class CompoundInterestScreenInOthers extends StatefulWidget {
  const CompoundInterestScreenInOthers({super.key});

  @override
  State<CompoundInterestScreenInOthers> createState() =>
      _CompoundInterestScreenInOthersState();
}

class _CompoundInterestScreenInOthersState
    extends State<CompoundInterestScreenInOthers> {
  ...
  void _handleCalculation() {
    if (_amountController.text.isEmpty) {
      ...
      double a = amount * pow((1 + (interest / 100)), term);
      compoundInterest = a.toStringAsFixed(2);
      double b = a - amount;
