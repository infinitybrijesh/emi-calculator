...
class PMSurakshaBimaAccidentScreen extends StatefulWidget {
  const PMSurakshaBimaAccidentScreen({super.key});

  @override
  State<PMSurakshaBimaAccidentScreen> createState() =>
      _PMSurakshaBimaAccidentScreenState();
}

class _PMSurakshaBimaAccidentScreenState
    extends State<PMSurakshaBimaAccidentScreen> {
                  ...
                  children: [
                          ...
                          labelStyle: TextStyle(
                              color: _ageController.text.isEmpty
                                  ...
                                  : int.parse(_ageController.text) < 18 ||
                                          int.parse(_ageController.text) > 70
                                      ? Appcolor.red
                                      : Appcolor.primaryColor),
                    ...
                    _ageController.text.isEmpty
                        ...
                        : int.parse(_ageController.text) < 18
                            ...
                            : int.parse(_ageController.text) > 70
                                ? const Text("Enter Age Less Than 70",
                                    style: TextStyle(color: Appcolor.red))
                                : const SizedBox(),
                    const SizedBox(
                      height: 10,
                    ...
                    child: Column(children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                              "₹ ${12 * (70 - int.parse(_ageController.text))}"),
                        ],
                      ),
                      const Divider(),
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: const Text(
                                "You need to pay the premium amount ₹ 12/-every year to get accident insurance cover of Rs.2 lakh/-."),
                          ),
                        ],
                      ),
                      const Divider(),
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          SizedBox(
                            width: MediaQuery.of(context).size.width * 0.83,
                            child: Text(
                                "So, you will be paying a total of ₹ ${12 * (70 - int.parse(_ageController.text))}/- during your  premium paying period of ${70 - int.parse(_ageController.text)} years."),
                          ),
                        ],
                      ),
                      const Divider(),
