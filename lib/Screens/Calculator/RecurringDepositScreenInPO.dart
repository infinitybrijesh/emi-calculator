...
class RecurringDepositScreenInPO extends StatefulWidget {
  const RecurringDepositScreenInPO({super.key});

  @override
  State<RecurringDepositScreenInPO> createState() =>
      _RecurringDepositScreenInPOState();
}

class _RecurringDepositScreenInPOState
    extends State<RecurringDepositScreenInPO> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text(
          'Recurring Deposit Post Office (RD)',
          style: TextStyle(
                            ...
                            child: Column(children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                      '₹ ${formatter.format(totalAmount.round())}'),
                                ],
                              ),
                              const Divider(),
                              GestureDetector(
  ...
  void _handelCalculation() {
    double amount =
        double.parse(_depositamountController.text.replaceAll(",", ""));
    double iRate = double.parse(_interestrateController.text) / 400;
    double term = 60;
    maturityAmount =
        amount * ((pow(1 + iRate, 20) - 1) / (1 - pow(1 + iRate, -1 / 3)));
    totalAmount = amount * term;
    totalInterest = maturityAmount - totalAmount;
  }
}
